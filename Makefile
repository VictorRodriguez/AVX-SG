...
all:
	...
	gcc -O3 -march=icelake-server $(src_dir)dpbusd_epi32.c -o $(build_dir)dpbusd_epi32
...
static:
	...
	gcc -O3 -march=icelake-server $(src_dir)dpbusd_epi32.c -o $(build_dir)dpbusd_epi32 $(static_flags)
